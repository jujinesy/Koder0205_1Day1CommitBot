...
export declare type MultiMediaTemplates = MultiMediaTemplate<ChatType.MultiPhoto>;
export declare type MediaTemplates = MediaTemplate<ChatType.Audio> | MediaTemplate<ChatType.File> | ((MediaTemplate<ChatType.Photo> | MediaTemplate<ChatType.Video>) & SizedMediaItemTemplate) | MediaTemplate<ChatType.Text> | MultiMediaTemplates;
